...
<head>
  ...
  <!-- bootstrap core css -->
  <link rel="stylesheet" type="text/css" href="csss/css/bootstrap.css" />
  <!-- font awesome style -->
  <link rel="stylesheet" type="text/css" href="csss/css/font-awesome.min.css" />

  <!-- Custom styles for this template -->
  <link href="csss/css/style.css" rel="stylesheet" />
  <!-- responsive style -->
  <link href="csss/css/responsive.css" rel="stylesheet" />
</head>
<body>
             ...
             <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ">
                ...
                <li class="nav-item active">
                  ...
                  <li class="nav-item">
                  <c:if test="${ not empty logVO }">
                    <a class="nav-link" href="${ pageContext.request.contextPath }/updateForm">회원정보수정</a>
                  </c:if>
                </li>
                <li class="nav-item">
                  <c:if test="${ not empty logVO }">
                    <a class="nav-link" href="${ pageContext.request.contextPath }/deleteForm">회원탈퇴</a>
                  </c:if>
                </li>
                <li class="nav-item">
                  <c:if test="${ not empty logVO }">
                    <a class="nav-link" href="${ pageContext.request.contextPath }/accountOpen">계좌 개설</a>
                  </c:if>
                </li>
                <li class="nav-item">
                  <c:if test="${ not empty logVO }">
                    <a class="nav-link" href="${ pageContext.request.contextPath }/accountList">내 계좌 보기</a>
                  </c:if>  
                </li>
                <li class="nav-item">
                  <c:if test="${ not empty logVO }">
                    <a class="nav-link" href="${ pageContext.request.contextPath }/transfer">계좌 이체</a>
                  </c:if>
                </li>
                <li class="nav-item">
                  <c:if test="${ not empty logVO }">
                    <a class="nav-link" href="${ pageContext.request.contextPath }/accHistory">거래 내역 한 눈에 보기</a>
                  </c:if>
                </li>
                <li class="nav-item">
                  <c:if test="${ not empty logVO }">
                    <a class="nav-link" href="${ pageContext.request.contextPath }/register">상품 등록</a>
                  </c:if>
                </li>
              </ul>
            </div>
    ...
    <section class="slider_section ">
      <div class="container ">
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="img-box">
              <img src="csss/images/slider-img.png" alt="">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-7 col-md-6">
          <div class="img-box">
            <img src="csss/images/about-img.jpg" alt="">
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="professional_section layout_padding">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <div class="img-box">
            <img src="csss/images/professional-img.png" alt="">
          </div>
        </div>
        <div class="col-md-6 ">
          <div class="detail-box">
    ...
    <div class="container ">
      ...
      <div class="row">
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box ">
            <div class="img-box">
              <img src="csss/images/s1.png" alt="" />
            </div>
            <div class="detail-box">
              <h5>
                Maintenance
        ...
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box ">
            <div class="img-box">
              <img src="csss/images/s2.png" alt="" />
            </div>
            <div class="detail-box">
              <h5>
                Electrical
        ...
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box ">
            <div class="img-box">
              <img src="csss/images/s3.png" alt="" />
            </div>
            <div class="detail-box">
              <h5>
                Plumbing
        ...
        <div class="owl-carousel">
          <div class="item">
            <div class="box">
              <div class="client_id">
                <div class="img-box">
                  <img src="csss/images/client-1.jpg" alt="">
                </div>
          ...
          <div class="item">
            <div class="box">
              <div class="client_id">
                <div class="img-box">
                  <img src="csss/images/client-2.jpg" alt="">
                </div>
                <div class="client_detail">
                  <div class="client_info">
                    <h6>
  ...
  <script src="csss/js/jquery-3.4.1.min.js"></script>
  <script src="csss/js/bootstrap.js"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/owl.carousel.min.js">
  </script>
  <script src="csss/js/custom.js"></script>
  <!-- Google Map -->
